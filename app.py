        ...
        if username:
            ...
            while st.session_state.index <= 5:
                if st.session_state.index == 0:
                    q1.text_area(label="BART", value=questions[0], key='q1')
                if st.session_state.index == 1:
                    q1.text_area(label="BART", value=questions[0], key='q1')
                    r1.text_area(label=username, value=st.session_state.responses[0], key=r1)
                    q2.text_area(label="BART", value=questions[1], key='q2')
                if st.session_state.index == 2:
                    q1.text_area(label="BART", value=questions[0], key='q1')
                    r1.text_area(label=username, value=st.session_state.responses[0], key='r1')
                    q2.text_area(label="BART", value=questions[1], key='q2')
                    r2.text_area(label=username, value=st.session_state.responses[0], key='r2')
                    q3.text_area(label="BART", value=questions[2], key='q3')
                if st.session_state.index == 3:
                    q1.text_area(label="BART", value=questions[0], key='q1')
                    r1.text_area(label=username, value=st.session_state.responses[0], key='r1')
                    q2.text_area(label="BART", value=questions[1], key='q2')
                    r2.text_area(label=username, value=st.session_state.responses[1], key='r2')
                    q3.text_area(label="BART", value=questions[2], key='q3')
                    r3.text_area(label=username, value=st.session_state.responses[2], key='r3')
                    q4.text_area(label="BART", value=questions[3], key='q4')
                if st.session_state.index == 4:
                    ...
                    r3.text_area(label=username, value=st.session_state.responses[2], key='r3')
                    q4.text_area(label="BART", value=questions[3], key='q4')
                    r4.text_area(label=username, value=st.session_state.responses[3], key='r4')
                    q5.text_area(label="BART", value=questions[4], key='q5')
                if st.session_state.index == 4:
                    q1.text_area(label="BART", value=questions[0], key='q1')
                    r1.text_area(label=username, value=st.session_state.responses[0], key='r1')
                    q2.text_area(label="BART", value=questions[1], key='q2')
                    ...
                    r4.text_area(label=username, value=st.session_state.responses[3], key='r4')
                    q5.text_area(label="BART", value=questions[4], key='q5')
                    r5.text_area(label=username, value=st.session_state.responses[4], key='r5')
